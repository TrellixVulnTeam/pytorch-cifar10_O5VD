...
def bitmr50x1(**kwargs):
    return ResNetV2([3, 4, 6, 3], 1, **kwargs)


def bitmr50x3(**kwargs):
    return ResNetV2([3, 4, 6, 3], 3, **kwargs)


def bitmr101x1(**kwargs):
    return ResNetV2([3, 4, 23, 3], 1, **kwargs)


def bitmr101x3(**kwargs):
    return ResNetV2([3, 4, 23, 3], 3, **kwargs)


def bitmr152x2(**kwargs):
    return ResNetV2([3, 8, 36, 3], 2, **kwargs)


def bitmr152x4(**kwargs):
    return ResNetV2([3, 8, 36, 3], 4, **kwargs)
