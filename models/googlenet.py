...
class GoogLeNet(nn.Module):
    ...
    def __init__(self, num_classes=10, aux_logits=False, transform_input=False, init_weights=False, blocks=None):
        ...
        self.conv1 = conv_block(3, 192, kernel_size=3, stride=1, padding=1)
